 ...
 * @author Usuario
 */
public class PesquisaAnotacoesView extends javax.swing.JFrame {

    private final AnotacoesDAO anotacoesDAO = new AnotacoesDAO();
    private AnotacoesEntity anotaEnt;

    public PesquisaAnotacoesView() {
//        tfPesquisa.setDocument(new FixedLengthDocument(10));
        initComponents();
        ajustarTabela();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Anotações");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        anotaEnt = new AnotacoesEntity();
        new AnotacoesView(anotaEnt).setVisible(true);
        this.dispose();
    ...
    private void tbAgendaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAgendaMousePressed
        ...
        AnotacoesEntity anota = new AnotacoesEntity();
        anotaEnt = new AnotacoesEntity();
        anota.setId(id);
        bEditar.setEnabled(true);
        for (AnotacoesEntity a : anotacoesDAO.selecionaAnotacao(anota)) {
            anotaEnt = a;
        }
        System.out.print(anotaEnt.getTitulo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaAnotacoesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void preencherTabela() {
        try {
            ...
            tabela.setNumRows(0);
            String tituloAnotacao = tfPesquisa.getText() + "%";
            for (AnotacoesEntity c : anotacoesDAO.list(tituloAnotacao)) {
                tabela.addRow(new Object[]{c.getId(), c.getTitulo(), c.getData()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
