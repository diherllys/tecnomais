 ...
 * @author Usuario
 */
public class PesquisaOperacaoSaidaView extends javax.swing.JFrame {

    private final OperacaoDeSaidaDAO operacaoDeSaidaDAO = new OperacaoDeSaidaDAO();
    private OperacaoDeSaidaEntity operacaoDeSaida;

    public PesquisaOperacaoSaidaView() {
        initComponents();
        ajustarTabela();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Operação de Saida");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        operacaoDeSaida = new OperacaoDeSaidaEntity();
        new OperacaoDeSaidaView(operacaoDeSaida, false).setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        new OperacaoDeSaidaView(operacaoDeSaida, true).setVisible(true);
        this.dispose();
    ...
    private void tbOperacaoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbOperacaoMousePressed
        ...
        try {
            for (OperacaoDeSaidaEntity o : operacaoDeSaidaDAO.selecionaOperacao(codigo)) {
                operacaoDeSaida = o;
            }
        } catch (SQLException ex) {
            Logger.getLogger(PesquisaOperacaoSaidaView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tbOperacaoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbOperacaoKeyPressed
        ...
        OperacaoDeSaidaEntity ce = new OperacaoDeSaidaEntity();
        operacaoDeSaida = new OperacaoDeSaidaEntity();
        ce.setId(id);
        bEditar.setEnabled(true);
        try {
            for (OperacaoDeSaidaEntity o : operacaoDeSaidaDAO.selecionaOperacao(id)) {
                operacaoDeSaida = o;
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaOperacaoSaidaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void preencherTabela() {
        try {
            ...
            for (OperacaoDeSaidaEntity c : operacaoDeSaidaDAO.listar(nomeOperacao)) {
                tabela.addRow(new Object[]{c.getId(), c.getCodigo(), c.getNome(), c.getNaturezaDaOperacao(), c.getCaracteristicaDeOperacao()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
