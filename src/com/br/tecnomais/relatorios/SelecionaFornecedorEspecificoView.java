 ...
 * @author Diherllys
 */
public class SelecionaFornecedorEspecificoView extends javax.swing.JDialog {

    ConectaBanco conn = new ConectaBanco();
    private final FornecedorDAO fd = new FornecedorDAO();
    private FornecedorEntity fornecedorEntity;
    private Integer fornecedorId;

    public SelecionaFornecedorEspecificoView(java.awt.Frame parent, boolean modal, String consulta) {
        super(parent, modal);
        conn.conectar();
        initComponents();
        ajustarTabela();
    ...
    private void jtTabelaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtTabelaMousePressed
        ...
        fornecedorId = (Integer.parseInt(jtTabela.getValueAt(linha, 0).toString()));
    }//GEN-LAST:event_jtTabelaMousePressed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            this.dispose();
            gerarRelatorio(fornecedorId);
            this.setDefaultCloseOperation(SelecionaFornecedorEspecificoView.DISPOSE_ON_CLOSE);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionaFornecedorEspecificoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelecionaFornecedorEspecificoView dialog = new SelecionaFornecedorEspecificoView(new javax.swing.JFrame(), true, null);
    ...
    public void preecherTabela(String consulta) {
        try {
            ...
            tb.setNumRows(0);
            for (FornecedorEntity p : fd.listar(consulta + "%")) {
    ...
    public List<FornecedorEntity> dadosProduto() {
        List<FornecedorEntity> lista = new ArrayList<>();
        lista.add(fornecedorEntity);
        return lista;
    }
    ...
    private void gerarRelatorio(int id) throws JRException, SQLException {
        ...
        parametros.put("fornecedorEspecifico", id);
        JasperPrint jp = JasperFillManager.fillReport("./relatorio/fornecedorEspecifico.jasper", parametros, conn.conn);
