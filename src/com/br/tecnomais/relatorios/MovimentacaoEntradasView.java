 ...
 * @author Usuario
 */
public class MovimentacaoEntradasView extends javax.swing.JDialog {
     ...
     */
    public MovimentacaoEntradasView(java.awt.Frame parent, boolean modal) {
        super(parent, false);
        initComponents();
        con.conectar();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório de Movimentação(Entradas)");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btGerarRelatorio, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MovimentacaoEntradasView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MovimentacaoEntradasView dialog = new MovimentacaoEntradasView(new javax.swing.JFrame(), true);
    ...
    private void geraRelatorio(String logomarca) {
        try {
            ...
            JasperPrint jp = JasperFillManager.fillReport("./relatorio/movimentacaoEntradas.jasper", p, con.conn);
