 ...
 * @author Reginaldo
 */
public class SelecionaClienteContasView extends javax.swing.JDialog {
     ...
     */
    public SelecionaClienteContasView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionaClienteContasView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelecionaClienteContasView dialog = new SelecionaClienteContasView(new javax.swing.JFrame(), true);
