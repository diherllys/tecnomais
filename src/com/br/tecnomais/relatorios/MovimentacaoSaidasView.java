 ...
 * @author Usuario
 */
public class MovimentacaoSaidasView extends javax.swing.JDialog {
     ...
     */
    public MovimentacaoSaidasView(java.awt.Frame parent, boolean modal) {
        super(parent, false);
        initComponents();
        con.conectar();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório de Movimentação(Saidas)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MovimentacaoSaidasView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MovimentacaoSaidasView dialog = new MovimentacaoSaidasView(new javax.swing.JFrame(), true);
    ...
    private void geraRelatorio(String logomarca) {
        try {
            ...
            JasperPrint jp = JasperFillManager.fillReport("./relatorio/movimentacaoSaidas.jasper", p, con.conn);
