 ...
 * @author Usuario
 */
public class VendasTotaisPorFormaDePagamento extends javax.swing.JDialog {
     ...
     */
    public VendasTotaisPorFormaDePagamento(java.awt.Frame parent, boolean modal) {
        super(parent, false);
        initComponents();
        con.conectar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendasTotaisPorFormaDePagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VendasTotaisPorFormaDePagamento dialog = new VendasTotaisPorFormaDePagamento(new javax.swing.JFrame(), true);
    ...
    private void geraRelatorio(String logomarca) {
        try {
            FalcatruaDAO dao = new FalcatruaDAO();
            ...
            p.put("dinheiro", dao.dinheiroTotal(tfDtInicial.getText(), tfDtFinal.getText())/100);
            p.put("parcelado", dao.totalParcelado()/100);
            p.put("cc", dao.totalCartaoCredito()/100);
            p.put("cd", dao.totalCartaoDebito()/100);
            p.put("total", dao.totalGeral()/100);
            JasperPrint jp = JasperFillManager.fillReport("./relatorio/valoresTotaisPorFormaDePagamento.jasper", p, con.conn);
