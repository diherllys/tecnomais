...
/**
 *
 * @author Diherllys Lima Leal
 */
public class RelatoriosMovimentacaoView extends javax.swing.JFrame {
    ...
    public RelatoriosMovimentacaoView(UsuarioEntity u) {
        initComponents();
        centralizar();
        con.conectar();
        this.u = u;
    ...
    private void initComponents() {
        ...
        lbContasReceber.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        lbContasReceber.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/br/tecnomais/images/contasreceber.png"))); // NOI18N
        lbContasReceber.setText("<html>Relatório <p>de Contas a Receber");
        ...
        lbUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/br/tecnomais/images/saida.png"))); // NOI18N
        lbUsuario.setText("<html>Relatórios <p>de Saídas");
        ...
        lbClientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/br/tecnomais/images/icon-entrada.png"))); // NOI18N
        lbClientes.setText("<html>Relatório <p>de Entrada");
        ...
        lbAlgo6.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        lbAlgo6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/br/tecnomais/images/fluxoCaixa 80x80.png"))); // NOI18N
        lbAlgo6.setText("<html>Relatório <p>de Fluxo de Caixa");
        ...
        lbFilial.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        lbFilial.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/br/tecnomais/images/contasPagar 80x80.png"))); // NOI18N
        lbFilial.setText("<html>Relatório <p>de Contas Pagar");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {lbAlgo2, lbAlgo3, lbAlgo4, lbAlgo5, lbAlgo6, lbAlgo8, lbAlgo9, lbClientes, lbContasReceber, lbFornecedor, lbUsuario});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {lbAlgo2, lbAlgo3, lbAlgo4, lbAlgo5, lbAlgo6, lbAlgo8, lbAlgo9, lbClientes, lbContasReceber, lbFornecedor, lbUsuario});
    ...
    private void lbUsuarioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbUsuarioMousePressed
        try {
            new TiposDeSaidaRelatorio(this, false, u).setVisible(true);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void lbClientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbClientesMousePressed
        new MovimentacaoEntradaPrt(this, true).setVisible(true);
    ...
    private void lbContasReceberMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbContasReceberMousePressed
        new OptionView("Contas Por Data", "Contas por Cliente", null).setVisible(true);
//        new RelatorioContasReceber(this, false, u).setVisible(true);
    ...
    private void lbAlgo6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbAlgo6MouseEntered
        lbAlgo6.setForeground(Color.red);
    ...
    private void lbAlgo6MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbAlgo6MouseExited
        lbAlgo6.setForeground(Color.black);
    ...
    private void lbAlgo6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbAlgo6MousePressed
        new TiposMovimentacao(this, true, u).setVisible(true);
...
//        new PesquisaFilialView().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatoriosMovimentacaoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatoriosMovimentacaoView(null).setVisible(true);
            }
        });
    }
