 ...
 * @author Usuario
 */
public class LancaSaidaView extends javax.swing.JFrame {

    NovaData data = new NovaData();

    public LancaSaidaView() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (tfDescricao.getText().isEmpty() || tfUsuario.getText().isEmpty() || tfSenha.getText().isEmpty() || tfValor.getText().isEmpty() || cbCaixa.getSelectedIndex() == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LancaSaidaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
